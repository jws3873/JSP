...
<body>
	...
	<tr>
		...
		<td colspan="2" align="center">
			<a href="<%=request.getContextPath()%>/user_min.do">쇼핑몰 홈</a>&nbsp;&nbsp;&nbsp;
			<a href="<%=request.getContextPath()%>/user_cart.do">장바구니</a>&nbsp;&nbsp;&nbsp;
	...
	<tr>
				<td width="300" align="center" valign="top">
					<table cellspacing="0">
						...
						<tr>
							<td> <a href="<%=request.getContextPath()%>/user_category_list.do?code=${dto.getCategory_code() }">
