...
public class BoardDAO {
	...
	public List<BoardDTO> getsearchList(String field,String keward){
		List<BoardDTO> list = new ArrayList<BoardDTO>();
		try {
			openConn();
			...
			if(field.equals("title")) {
				...
				sql = "select *from board where board_title like ? or "
						+ " board_cont like ? order by board_no desc";
				pstmt = con.prepareStatement(sql);
				pstmt.setString(1, "%"+keward+"%");
				pstmt.setString(2, "%"+keward+"%");
			}else {
