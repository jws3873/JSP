...
<body>
	...
	<h3>${dto.getUpload_writer() }님 게시물 상세내역 페이지</h3>
	<hr width="30%" color="red">
	 <br>
	 ...
	 <tr>
	 	<th>작성자</th>
	 	<td> 
	 	<textarea rows="7" cols="20">${dto.getUpload_cont() }</textarea>
	 	</td>
	 </tr>
	 ...
	 <tr>
	 	<th>첨부파일</th> 
	 	<td> <a href="<%=request.getContextPath()%>/upload/${dto.getUpload_file() }" target="_blank">
	 	${dto.getUpload_file()}</a></td>
	 </tr>
